        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(color: Colors.grey[800], letterSpacing: 2.0, fontSize: 18.0, fontWeight: FontWeight.bold),
            ),
                ...
                showDialog(
                  ...
                  builder: (_) => AlertDialog(
                    ...
                    actions: [
                      ...
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChangeBookingTime(booking: booking, badmintonHall: badmintonHall),
                      ),
                    ));
              },
            ),
