                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              FlatButton(
                                color: blue,
                                child: Text('Click to see Details', 
                                  style: TextStyle(
                                    color: Colors.white, 
                                    fontWeight: FontWeight.bold),
                                  ),
                                onPressed: (){
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(builder: (context) => 
                                      MyBookingDetails(booking: myBookingList[index], badmintonHall: getBadmintonHall(myBookingList[index].hallId))
                                    )
                                  );
                                },
                              )
                            ...
                            onPressed: (){
                              showDialog(
                                ...
                                builder: (_) =>AlertDialog(
                                  title: Text('You want to cancel this booking', 
                                  ...
                                  actions: [
                                    ...
                                    FlatButton(
                                      onPressed:() async{
                                        ...
                                        print(myBookingList[index].bookingId);
