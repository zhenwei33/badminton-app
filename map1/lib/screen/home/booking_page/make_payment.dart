...
class MakePayment extends StatelessWidget {
  ...
  MakePayment(this.badmintonHall, this.slotNumber, this.selectedBookingDate, this.selectedBookingTime, this.selectedBookingHour);
    ...
    return WillPopScope(
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text("RM ${(badmintonHall.pricePerHour*selectedBookingHour).toStringAsFixed(2)}",
                      style: TextStyle(
                          fontSize: 40,
                          color: Colors.white,
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 30),
              Text("Court no. $slotNumber", style: receiptText),
              SizedBox(height: 15),
              Text("${DateFormat('dd/MM/yyyy').format(DateTime.parse(selectedBookingDate))}", style: receiptText),
              SizedBox(height: 15),
              Row(
                      ...
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (_) =>AlertDialog(
                            ...
                            content: Text('Your booking is not created, are you sure want to cancel it'),
                            actions: [
                              FlatButton(
